import { E as LocalImageUsedWrongly, G as RemoteImageNotAllowed, I as NoImageMetadata, M as MissingImageDimension, T as InvalidImageService, d as ExpectedNotESMImage, f as FailedToFetchRemoteImageDimensions, l as ExpectedImage, nt as UnsupportedImageFormat, t as AstroError, tt as UnsupportedImageConversion, u as ExpectedImageOptions, x as IncompatibleDescriptorOptions } from "./errors_BpmWUuHx.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_C8OxgMLK.mjs").catch((e) => {
